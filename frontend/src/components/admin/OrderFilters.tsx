                ...
                <div className="w-full">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-10 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent text-gray-900 placeholder-gray-400 shadow-sm transition-all"
                        />
                        {searchTerm && (
                            <button
                ...
                <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent text-gray-700 shadow-sm transition-all bg-white"
                                        placeholder="Từ ngày"
                                    />
                                </div>
                                {startDate && (
                    ...
                    <div className="w-full md:w-64">
                        <select
                            ...
                            className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent text-gray-900 shadow-sm transition-all bg-white"
                        >

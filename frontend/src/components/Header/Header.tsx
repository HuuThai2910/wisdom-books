        ...
        <div className="container mx-auto flex items-center justify-between px-6 py-2 text-gray-800">
          ...
          >
            <div className="w-14 h-14 rounded-full overflow-hidden">
              <img
                src={isHomePage && opacity <= 0.5 ? logoImg1 : logoImg}
                alt="logo"
            ...
            <div className="w-30 h-15 overflow-hidden">
              <img
                src={isHomePage && opacity <= 0.5 ? wisbook1 : wisbook}
                alt="WisBook"
          ...
          <div className="hidden md:flex space-x-10 text-lg font-medium items-center">
            <Link
              ...
              style={{
                color: !isHomePage || opacity > 0.5 ? "white" : "#2563eb",
              }}
            >
              ...
              <span
                ...
                style={{
                  backgroundColor:
                    !isHomePage || opacity > 0.5 ? "white" : "#2563eb",
                }}
              ></span>
            </Link>
            <Link
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-blue-100 text-xs">
                            Khám phá thế giới tri thức đa dạng
                          </p>
                        </div>
                        <div className="text-white/90 text-xs font-medium">
                          {bookCategories.length} thể loại
                        </div>
                      </div>
                    </div>
            ...
            >
              <span className="font-bold text-xl">Về chúng tôi</span>
              <span
                className="absolute -bottom-1 left-0 w-0 h-0.5 group-hover:w-full transition-all duration-300"
                style={{
                  backgroundColor:
                    ...
                    <div className="p-2">
                      ...
                      {(() => {
                        ...
                        if (roleUpper === "1" || roleUpper === "ADMIN") {
                          ...
                          roleUpper === "4" ||
                          roleUpper === "WARE_HOUSE_STAFF" ||
                          roleUpper === "WAREHOUSE_STAFF"
                        ) {
                      ...
                      <button
                        onClick={async () => {
                          try {
                            ...
                            Cookies.remove("refresh_token", { path: "/" });
                            toast.error(
                              "Đã có lỗi xảy ra, nhưng bạn đã được đăng xuất"
                            );
                            navigate("/");
                            window.location.reload();
                          }

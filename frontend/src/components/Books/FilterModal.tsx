            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="text-xs text-gray-600 font-medium mb-1 block">
                  Giá thấp nhất: {filters.priceRange[0].toLocaleString("vi-VN")}
                  ₫
                </label>
                <input
                  type="range"
                  ...
                  style={{
                    background: `linear-gradient(to right, #f59e0b 0%, #f59e0b ${
                      (filters.priceRange[0] / 5000000) * 100
                    }%, #fde68a ${
                      (filters.priceRange[0] / 5000000) * 100
                    }%, #fde68a 100%)`,
                  }}
              ...
              <div>
                <label className="text-xs text-gray-600 font-medium mb-1 block">
                  Giá cao nhất: {filters.priceRange[1].toLocaleString("vi-VN")}₫
                </label>
                <input
                  type="range"
                  min="0"
                  ...
                  style={{
                    background: `linear-gradient(to right, #f59e0b 0%, #f59e0b ${
                      (filters.priceRange[1] / 5000000) * 100
                    }%, #fde68a ${
                      (filters.priceRange[1] / 5000000) * 100
                    }%, #fde68a 100%)`,
                  }}
            ...
            <div className="space-y-3">
                ...
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, #a855f7 0%, #a855f7 ${
                      ((filters.yearRange[0] - 1900) / (currentYear - 1900)) *
                      100
                    }%, #e9d5ff ${
                      ((filters.yearRange[0] - 1900) / (currentYear - 1900)) *
                      100
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, #a855f7 0%, #a855f7 ${
                      ((filters.yearRange[1] - 1900) / (currentYear - 1900)) *
                      100
                    }%, #e9d5ff ${
                      ((filters.yearRange[1] - 1900) / (currentYear - 1900)) *
                      100

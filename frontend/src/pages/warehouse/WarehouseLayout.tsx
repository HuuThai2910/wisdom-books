...
import { Home, Warehouse, Menu, MoreVertical } from "lucide-react";
...
export default function WarehouseLayout({ children }: WarehouseLayoutProps) {
  ...
  const menuItems = [
    { name: "Dashboard", path: "/warehouse/dashboard", icon: Home },
    { name: "Kho", path: "/warehouse/inventory", icon: Warehouse },
  ];

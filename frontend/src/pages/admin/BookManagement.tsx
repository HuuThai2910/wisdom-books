      ...
      if (modalMode === "create") {
        ...
        if (response.success && response.data && uploadedFiles.length > 0) {
          ...
          try {
            ...
            await bookApi.uploadBookImages(newBookId, uploadedFiles);
            toast.success(
            ...
            toast.error("Thêm sách thành công nhưng upload ảnh thất bại!", {
              id: "upload",
            });
          }
        }
        ...
        if (response.success && uploadedFiles.length > 0) {
          try {
            ...
            await bookApi.uploadBookImages(selectedBook.id, uploadedFiles);
            toast.success(
              `Đã tải lên ${uploadedFiles.length} ảnh thành công!`,
              { id: "upload" }
            );
            ...
            console.error("Upload error:", uploadError);
            toast.error("Cập nhật sách thành công nhưng upload ảnh thất bại!", {
              id: "upload",
            });
          }
        }

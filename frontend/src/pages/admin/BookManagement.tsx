...
export default function BookManagement() {
    ...
    const toggleColumn = (column: keyof typeof visibleColumns) => {
        // Kiểm tra xem có bao nhiêu cột đang hiển thị
        const currentlyVisibleCount = Object.values(visibleColumns).filter(
            (v) => v
        ).length;

        // Nếu đang muốn tắt cột cuối cùng thì không cho phép
        if (currentlyVisibleCount === 1 && visibleColumns[column]) {
            toast.error("Phải giữ ít nhất 1 cột hiển thị!");
            return;
        }
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-gray-200">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg transform hover:scale-105"
                            >
                                <FaPlus className="text-sm" /> Thêm mới
                            </button>
                            <button
                                onClick={handleRefresh}
                                className="p-2.5 hover:bg-gray-100 rounded-lg transition-all shadow-sm hover:shadow-md"
                                title="Làm mới"
                            >
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full table-fixed">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    {visibleColumns.stt && (
                                        <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-16 whitespace-nowrap">
                                            STT
                                        </th>
                                    )}
                                    {visibleColumns.image && (
                                        <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 w-24 whitespace-nowrap">
                                            Hình ảnh
                                        </th>
                                    )}
                                    {visibleColumns.title && (
                                        <th
                                            className="px-4 py-3 text-left text-sm font-semibold text-gray-700 cursor-pointer hover:bg-gray-100 transition-colors whitespace-nowrap w-45"
                                    ...
                                    {visibleColumns.supplier && (
                                        <th
                                            className="px-4 py-3 text-left text-sm font-semibold text-gray-700 cursor-pointer hover:bg-gray-100 transition-colors whitespace-nowrap"
                                            onClick={() =>
                                                handleSort(
                                    ...
                                    {visibleColumns.price && (
                                        <th
                                            className="px-4 py-3 text-left text-sm font-semibold text-gray-700 cursor-pointer hover:bg-gray-100 transition-colors whitespace-nowrap w-28"
                                            onClick={() =>
                                    ...
                                    {visibleColumns.quantity && (
                                        <th
                                            className="px-4 py-3 text-left text-sm font-semibold text-gray-700 cursor-pointer hover:bg-gray-100 transition-colors whitespace-nowrap w-24"
                                            onClick={() =>
                                                handleSort("quantity")
                                            }
                                        >
                                    ...
                                    {visibleColumns.actions && (
                                        <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-32 whitespace-nowrap">
                                            Actions
                                        </th>
                                    )}
                                </tr>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {loading ? (
                                    ...
                                    books.map((book, index) => (
                                        ...
                                        >
                                            {visibleColumns.stt && (
                                                <td className="px-2 py-3 text-sm text-gray-700 w-16">
                                            ...
                                            {visibleColumns.image && (
                                                <td className="px-4 py-3">
                                                    ...
                                                    book.bookImage.length >
                                                        0 ? (
                                                        <img
                                                            src={`https://hai-project-images.s3.us-east-1.amazonaws.com/${book.bookImage[0].imagePath}`}
                                                            alt={book.title}

...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-5 relative overflow-hidden"
      ...
      <div className={`relative overflow-hidden w-3xl max-w-full min-h-[600px] rounded-[30px] 
        bg-linear-to-br from-white to-[#f0f4ff]
        ...
        <div className={`absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-all duration-600 ease-in-out
          ...
          <div className={`h-full text-white relative -left-full w-[200%] transition-transform duration-600 ease-in-out

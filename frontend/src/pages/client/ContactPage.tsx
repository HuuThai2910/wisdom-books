        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-2xl text-gray-700 leading-relaxed font-medium">
              ...
              <span className="text-blue-600 font-bold">lắng nghe</span> và{" "}
              <span className="text-blue-600 font-bold">hỗ trợ</span> bạn
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 md:p-10 border-2 border-blue-100">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Gửi <span className="text-blue-600">Tin Nhắn</span>
                  </h2>
                </div>
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                ...
                <div className="absolute bottom-0 p-6 text-white">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-2xl font-bold">WisBook Store</h3>
                  </div>
                  <p className="text-blue-200">Nơi khơi nguồn tri thức</p>
                </div>
              </div>
              ...
              <div className="relative bg-white rounded-3xl shadow-xl p-6 border-2 border-blue-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Kết Nối Với <span className="text-blue-600">Chúng Tôi</span>
                </h3>
                <p className="text-gray-600 text-sm mb-6">
                  Theo dõi để cập nhật sách mới & khuyến mãi hấp dẫn
                </p>

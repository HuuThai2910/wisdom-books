    ...
    return (
        <div className="min-h-screen bg-blue-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                {/* SHIPPING STEPS */}
                <div className="bg-blue-50 rounded-2xl p-10 mb-16 border border-blue-200 relative overflow-hidden">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-10 mb-16 border border-blue-100">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 text-center">
                        {shippingPartners.map((partner, i) => (
                            <div
                                key={i}
                                className="p-6 border-2 border-blue-200 rounded-xl hover:border-blue-600 hover:shadow-lg transition-all duration-300 cursor-pointer bg-blue-50"
                            >
